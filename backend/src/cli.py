"""
Scaler Learner Support RAG CLI and Command Interface.
Single source of truth for CLI argument parsing, interactive chat, and service dispatch.
"""
...
def format_cli_output(response: Dict[str, Any]):
